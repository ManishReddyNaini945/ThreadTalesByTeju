...
import { LayoutDashboard, Package, ShoppingBag, Tags, LogOut, Menu, X, ChevronRight, Settings, Ticket, MessageCircle } from "lucide-react";
...
const navItems = [
  ...
  { to: "/admin/comments", label: "Questions", icon: MessageCircle },
