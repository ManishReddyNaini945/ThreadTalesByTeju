      ...
      <div className="flex h-screen overflow-hidden" style={{ background: "var(--bg)" }}>
        ...
        <div className="hidden lg:flex w-1/2 h-screen flex-col items-center justify-center p-12 relative overflow-hidden flex-shrink-0"
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}
            ...
            <div className="mx-auto mb-8 w-40 h-40 rounded-full bg-white flex items-center justify-center shadow-lg" style={{ boxShadow: "0 0 24px rgba(200,164,92,0.25)" }}>
              <img src="/logo.png.png" alt="Thread Tales by Teju" className="w-32 h-32 object-contain" />
            </div>
